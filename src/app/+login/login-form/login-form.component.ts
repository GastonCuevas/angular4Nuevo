...
import { LookAndFeelService } from 'src/app/+core/services/look-and-feel.service';
...
export class LoginFormComponent implements OnInit {
  ...
  onLogin(loginModel: LoginModel): void {
    ...
    //           break;
    //         default:
    //           this.toastService.showMessageToast(
    //             'Error',
  ...
  onUpdatePassword(model: LoginUpdatePasswordModel) {
    ...
    //   this.loginService
    //     .updatePassword(this.updatePasswordModel, this.token)
    //     .finally(() => (this.isloading = false))
    //     .subscribe(
    //       (response: any) => {
