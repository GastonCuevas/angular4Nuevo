...
export class AppComponent implements OnInit, OnDestroy {
    ...
    private refreshToken() {
        ...
        this.subcription = this.result.subscribe((x) => {
            ...
            this.login.refreshToken().subscribe(undefined, error => this.resetResult());
        });
    }
    ...
    private loadStyle() {
        this.look.getLookAndFeel().subscribe(
            ...
            error => this.toasty.showToastyError(error, 'Ocurrio un error al cargar los estilos.'));
    }
